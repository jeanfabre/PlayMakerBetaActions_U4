...
namespace HutongGames.PlayMaker.Actions
{
	...
	[Tooltip("Transfer a value from one array to another, basically a copy/cut paste action on steroid")]
	public class ArrayTransferValue : FsmStateAction
	{
		...
		[Tooltip("Event sent if this arraList source does not contains that element ( described below)")]
